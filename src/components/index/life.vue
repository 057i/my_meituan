  ...
  <div class="m-life">
    <el-row>
      ...
      <ul class="nav">
        ...
        <li >
          <router-link to="/" class="apartment">美团酒店</router-link>
        </li>
        <li>
    ...
    <el-row>
      ...
      <el-col :span="6">
        ...
        <div class="m-life-login">
          ...
          <p class="m-life-login-name" v-if="!$store.state.userName">Hi！你好</p>
          <p class="m-life-login-name" v-else>Hi！{{$store.state.userName}}</p>
